...
def checkout():
    ...
    global cartNum
    cartNum = sum(user_cart_info.values()) if user_cart_info else 0
    return render_template("Checkout.html", dict_id_qty_prc_nm_dsc_vol = dict_id_qty_prc_nm_dsc_vol, item_quantity = item_quantity, subtotal = round(subtotal,2), d_left=round(35-subtotal,2),total=round(total,2))
